...
def gen_input_add(sig):
    ...
    <div class="col-sm-10">
    <input id='{0}' name="{0}" value="" type="text"  class="form-control"> {2}
    </div></div>'''.format( sig['en'], sig['zh'], sig['dic'][1])
    return (html_fangjia)
...
def gen_input_edit(sig):
    ...
    <label class="col-sm-2 control-label" for='{0}'><span style="color:red">*</span>{1}</label>
    <div class="col-sm-10">
    <input id='{0}' name="{0}" value="{{{{ post_info['{0}'][0] }}}}" type="text"  class="form-control"> {2}
    </div></div>'''.format( sig['en'], sig['zh'], sig['dic'][1])
    return (edit_fangjia)
...
def gen_input_view(sig):
    ...
    <div class="col-sm-8"><span class="val">{{{{ post_info['{0}'][0] }}}} {2}</span></div>
